...
class Book
{
    ...
    * @ORM\JoinColumn(name="autor_id", referencedColumnName="id",  nullable=true, onDelete="SET NULL")
     */
    private $autor;
     ...
     * Set autor
     *
     * @param \BookWebBundle\Entity\Autor $autor
     * @return Book
     */
    public function setAutor(\BookWebBundle\Entity\Autor $autor = null)
    {
        $this->autor = $autor;
     ...
     * Get autor
     *
     * @return \BookWebBundle\Entity\Autor 
     */
